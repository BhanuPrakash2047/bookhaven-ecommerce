...
public class BookController {
    ...
    private final BookService bookService;package com.sp_productservice.controller;
...
public class BookController {
    ...
    public ResponseEntity<?> createBook(
            ...
            throw new UnauthorizedException("Only admins can create the new book");
        }
    ...
    public ResponseEntity<?> deleteBook(
        ...
        if (!hasAdminRole(roles)) {
            throw new UnauthorizedException("Only admins can delete the book");
        }
        try {
